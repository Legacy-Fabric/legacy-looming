...
public class LegacyUtilsExtension {
    private final Project project;
    private final LegacyLoomingExtensionAPI extension;
    ...
    public Dependency apiModule(String moduleName, String fabricApiVersion) {
        return project.getDependencies()
                .create(getDependencyNotation(moduleName, fabricApiVersion));
    }

    public String apiModuleVersion(String moduleName, String fabricApiVersion) {
    ...
    private String getDependencyNotation(String moduleName, String fabricApiVersion) {
        return String.format("net.legacyfabric.legacy-fabric-api:%s:%s", moduleName, apiModuleVersion(moduleName, fabricApiVersion));
    }
    ...
    public Dependency yarn(String mcVersion, String buildNumber) {
        return project.getDependencies()
                .create(yarnNotation(mcVersion, buildNumber));
    }

    public Dependency yarn(String mcVersion, int buildNumber) {
        return yarn(mcVersion, Integer.toString(buildNumber));
    }
